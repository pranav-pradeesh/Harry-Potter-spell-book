...
requirements = python3,kivy==2.3.0,plyer,pyjnius,jnius,android,speech_recognition,pyaudio
...
# (list) Permissions - EXPANDED for persistent service and overlay
...
# (str) The Android arch to build for, choices: armeabi-v7a, arm64-v8a, x86, x86_64
# In older versions of python-for-android, only a single arch was supported
